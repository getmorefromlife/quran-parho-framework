...
export const t: Dict = {
  ...
  projector_mode: { en: "Live Projector / Presentation Mode", ur: "پروجیکٹر / پریزنٹیشن موڈ" },
  discussion_prompts: { en: "Circle Discussion Prompts", ur: "سرکل مباحثہ کے سوالات" },
  fullscreen_mode: { en: "Toggle Fullscreen", ur: "فل اسکرین آن/آف" },
  themes_verses: { en: "verses", ur: "آیات" },
  themes_search: { en: "Search themes...", ur: "موضوع تلاش کریں..." },
  search_all_translations: { en: "All translations", ur: "تمام تراجم" },
  search_selected_only: { en: "Selected only", ur: "منتخب تراجم" },
  search_contains: { en: "Contains", ur: "مشتمل" },
  search_exact_word: { en: "Exact word", ur: "پورا لفظ" },
  search_showing_of: { en: "Showing {shown} of {total}", ur: "{total} میں سے {shown}" },
  search_show_all: { en: "Show all", ur: "تمام دکھائیں" },
  ...
  tafseer_badge: { en: "Tafseer Resources", ur: "تفاسیر کے لنکس" },
  tafseer_title: { en: "Online Tafseer Portal", ur: "آن لائن تفسیر پورٹل" },
  tafseer_sub: {
    en: "Curated links to trusted tafseer resources across languages.",
    ur: "مختلف زبانوں میں مستند تفاسیر کے لنکس",
  },
  posters_badge: { en: "Posters", ur: "پوسٹرز" },
  posters_title: { en: "Download & Share", ur: "ڈاؤن لوڈ اور شیئر کریں" },
  posters_sub: {
    en: "Print-ready posters to promote your Qurʼān Parho circle in the neighborhood.",
    ur: "اپنے قرآن پڑھو حلقہ کو محلے میں فروغ دینے کے لیے پوسٹرز",
  },
  posters_open: { en: "Open", ur: "کھولیں" },
  posters_download: { en: "Download", ur: "ڈاؤن لوڈ" },
  hero_stat_blueprint: { en: "Blueprint", ur: "خاکہ" },
  hero_stat_cycles: { en: "Cycles", ur: "مراحل" },
  hero_stat_verses: { en: "Verses/turn", ur: "آیات فی بار" },
  hero_stat_qa: { en: "Q&A", ur: "سوال و جواب" },
  reader_settings: { en: "Reading Settings", ur: "مطالعہ کی ترتیبات" },
  present_translations: { en: "Translations", ur: "ترجمے" },
  present_sync_reader: { en: "Sync from Reader Settings", ur: "قارئین کی ترتیبات سے ہم آہنگ کریں" },
  present_sync_short: { en: "Sync", ur: "ہم آہنگ" },
  present_no_translation: { en: "No translation selected", ur: "کوئی ترجمہ منتخب نہیں" },
